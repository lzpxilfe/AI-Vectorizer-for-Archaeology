...
- The plugin metadata version is `0.1.4`; no matching GitHub release artifact is currently published. The development source also contains the experimental linear-TIN DEM/hillshade workflow.
